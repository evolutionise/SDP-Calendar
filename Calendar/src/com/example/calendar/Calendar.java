...
public class Calendar extends Activity {
	...
	/**
	 * @Event extends block 
	 * @param block that handles the event creation 
	 * 
	 */
	public void addEvent(Block block){
	    ...
	    values.put(CalendarProvider.EVENT, block.getTitle());
	    ...
	    cal.set(block.getYear(), block.getMonth(), block.getDay(), block.getHour(), block.getMinutes());
